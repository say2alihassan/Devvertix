...
const services: Service[] = [
  {
    ...
    description:
      "End-to-end product development — from architecture to paying users. We've shipped production AI apps from MVP to 1M+ downloads.",
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      "Production retrieval pipelines over private data. Hybrid search, reranking, evaluation harnesses.",
    icon: Database,
    span: "md:col-span-2",
  ...
  },
  {
    ...
    description:
      "Multi-step agents that plan, tool-use, and recover from failure.",
    icon: Bot,
    span: "md:col-span-1",
  ...
  },
  {
    title: "AI Chatbots",
    description:
      "On-brand conversational assistants grounded in your data.",
    icon: MessageSquare,
    span: "md:col-span-1",
  ...
  },
  {
    ...
    description:
      "Cross-platform (React Native, Flutter) and native. 11+ apps on the App Store & Google Play.",
    icon: Smartphone,
    span: "md:col-span-2",
  ...
  },
  {
    ...
    description:
      "Embed AI into your existing tools. Integrations, eval, observability.",
    icon: Cpu,
    span: "md:col-span-2",
    ...
    <section id="services" className="py-24 md:py-32 relative">
      <div className="max-w-6xl mx-auto px-4">
        <div className="max-w-2xl mb-14">
          ...
          >
            A senior team that covers the full stack — strategy, design,
            AI engineering, mobile, and go-to-market.
          </motion.p>
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "group relative rounded-2xl border border-border bg-surface/60 backdrop-blur-xl p-6 md:p-8 overflow-hidden hover:border-border-strong transition-all",
                  service.span
                )}
              >
                {/* Accent glow */}
